...
def VGGishModel(pretrained=True):
    features = make_layers()
    backbone = VGG(features)
    if pretrained:
        state_dict = hub.load_state_dict_from_url(model_urls['vggish'])
        backbone.load_state_dict(state_dict)

    postprocessor = Postprocessor()
    if pretrained:
        state_dict = hub.load_state_dict_from_url(model_urls['pca'])
        ...
        postprocessor.load_state_dict(state_dict)

    return VGGish(backbone, postprocessor)
